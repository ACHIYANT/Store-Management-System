...
async function generateTemplate() {
  ...
  instructions.addRow({
    text: "Required columns: name, address, gst_no, mobile_no.",
  });
  instructions.addRow({
    text: "gst_no must be 15 chars (capital letters/digits). mobile_no must be 10 digits starting with 6-9.",
  });
  instructions.addRow({
